...
export async function runStats(projectPath = process.cwd()) {
    ...
    if (totalChars > 15000)
        complexityRating = chalk.red.bold('HIGH (Refactor Recommended)');
    else if (totalChars > 5000)
        complexityRating = chalk.yellow.bold('MEDIUM');
