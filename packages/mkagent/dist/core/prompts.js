...
export async function runConfigPrompt() {
    ...
    const isCloud = ['openai', 'anthropic', 'gemini', 'groq'].includes(defaultModel);
...
export async function runLocalGeneratePrompt() {
    const description = await text({
