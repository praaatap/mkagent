            ...
            <div className="flex-1 py-12">
                ...
                <section id="endpoints" className="mb-16">
                    <div className="flex items-center gap-4 mb-6">
                        <span className="px-3 py-1 bg-[#00f5ff]/20 text-[#00f5ff] text-[10px] font-bold rounded-lg uppercase tracking-widest">POST</span>
                    ...
                    <div className="p-8 bg-[#0a0a0f] border border-white/5 rounded-3xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center text-xs">
                                <span className="font-mono text-[#00f5ff]">projectId</span>
                                <span className="text-white/40">string</span>
                            </div>
                            <div className="flex justify-between items-center text-xs">
                                <span className="font-mono text-[#00f5ff]">prompt</span>
                                <span className="text-white/40">string</span>
                            </div>
                        </div>
                    </div>
  ...
  "scaffold": {
    ...
    "styling": "tailwind-v4"
                ...
                <section id="playground">
                    ...
                    <div className="p-12 border border-white/5 rounded-[40px] bg-gradient-to-br from-white/5 to-transparent text-center">
                        <div className="w-16 h-16 bg-[#00f5ff]/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
