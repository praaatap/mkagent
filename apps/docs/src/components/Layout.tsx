                ...
                <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-12">
                        ...
                        <div className="hidden md:flex items-center gap-8 text-xs font-medium uppercase tracking-widest">
                            <NavLink to="/docs" className={({ isActive }) => isActive ? "text-accent-cyan" : "text-white/40 hover:text-white transition-colors no-underline"}>Documentation</NavLink>
                            <NavLink to="/terminal" className={({ isActive }) => isActive ? "text-accent-cyan" : "text-white/40 hover:text-white transition-colors no-underline"}>Playground</NavLink>
                        </div>
                    </div>
                    <div className="flex items-center gap-6">
                        ...
                        <button className="px-5 py-2 bg-accent-cyan text-black text-xs font-bold rounded-full hover:scale-105 transition-transform">
                            Get Started
                        </button>
                    </div>
                </div>
